...
function theme_adaptable_process_scss($scss, $theme) {
    ...
    $defaults = array(
        ...
        '[[setting:buttonhovercolor]]' => '#4aac54',
        '[[setting:buttoncolorscnd]]' => '#51666C',
        '[[setting:buttontextcolorscnd]]' => '#ffffff',
        '[[setting:buttonhovercolorscnd]]' => '#4aac54',
        ...
        '[[setting:headerbkcolor]]' => '#4aac54',
        '[[setting:headerbkcolor2]]' => '#4aac54',
        ...
        '[[setting:socialwallactionlinkhovercolor]]' => '#4aac54',
